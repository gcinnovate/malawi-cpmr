...
CREATE OR REPLACE VIEW flow_data_osc_view  AS
    SELECT
        ...
        (a.values->>'male_perpetrators_physicalviolence')::int male_perpetrators_physicalviolence,
        (a.values->>'female_perpetrators_physicalviolence')::int female_perpetrators_physicalviolence,
